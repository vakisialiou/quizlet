...
export async function generateMetadata() {
  ...
  return {
    icons: [
      {rel: 'icon', type: 'image/png', sizes: '120x120', url: `/favicon.png?v=${v}`},
      {rel: 'icon', type: 'image/png', sizes: '96x96', url: `/icons/favicon-96x96.png?v=${v}`},
      {rel: 'icon', type: 'image/png', sizes: '32x32', url: `/icons/favicon-32x32.png?v=${v}`},
      {rel: 'icon', type: 'image/png', sizes: '16x16', url: `/icons/favicon-16x16.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '76x76', url: `/icons/apple-icon-76x76.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '72x72', url: `/icons/apple-icon-72x72.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '60x60', url: `/icons/apple-icon-60x60.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '57x57', url: `/icons/apple-icon-57x57.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '180x180', url: `/icons/apple-icon-180x180.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '152x152', url: `/icons/apple-icon-152x152.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '144x144', url: `/icons/apple-icon-144x144.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '120x120', url: `/icons/apple-icon-120x120.png?v=${v}`},
      {rel: 'apple-touch-icon', sizes: '114x114', url: `/icons/apple-icon-114x114.png?v=${v}`},
    ],
  }
}
